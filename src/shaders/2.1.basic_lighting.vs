...
layout (location = 2) in vec3 aNormalInverse; // Normale inverse pour l'intérieur
layout (location = 3) in vec2 aTexCoord;   // Coordonnées de texture ajoutées

out vec3 FragPos;    // Position du fragment
out vec3 Normal;     // Normale du fragment
out vec3 NormalInverse; // Normale inverse pour l'intérieur
...
void main()
{
    ...
    Normal = aNormal;  
    NormalInverse = aNormalInverse; // Passer la normale inversée
